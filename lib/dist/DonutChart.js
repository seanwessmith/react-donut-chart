...
DonutChart.propTypes = {
    ...
    selectedOffset: _propTypes.number,
    emptyOffset: _propTypes.number,
    toggledOffset: _propTypes.number,
    formatValues: _propTypes.func,
    onMouseEnter: _propTypes.func,
    onClick: _propTypes.func,
    legend: _propTypes.bool
};
